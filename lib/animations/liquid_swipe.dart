...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue,  "Hi", "It's Me", "Haider"),
    ItemData(Colors.green,  "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow,  "Can be", "Used for", "Onboard design"),
    ItemData(Colors.pink,  "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "Do", "try it", "Thank you"),
  ];

    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: DataTable(
                border: TableBorder.all(color: Colors.grey,borderRadius: BorderRadius.circular(4)),
                dividerThickness: 4,
                // dataRowColor:const  MaterialStatePropertyAll(Colors.grey),
                columns: const [
                  DataColumn(
                    label: Text("Index"),
                  ),
                ...
                rows:const [
                  DataRow(cells: [
                    DataCell(Text("1")),
                    DataCell(Text("Haider Ali")),
                    DataCell(Text("Roll No 228")),
                  ]),
                  DataRow(cells: [
                    DataCell(Text("2")),
                    DataCell(Text("Usama Ali")),
                    DataCell(Text("Roll No 240")),
                  ]),
                  DataRow(cells: [
                    DataCell(Text("1")),
                    DataCell(Text("Haider Ali")),

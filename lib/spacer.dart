  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:const Column(
          ...
          children: [
            Text(" This is the Spacer() ",style: TextStyle(fontSize: 30,color: Colors.grey),),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(Icons.message,size: 40,color: Colors.purple,),
                Spacer(),
                Icon(Icons.message,size: 40,color: Colors.red,),
                ...
                Icon(Icons.message,size: 40,color: Colors.deepOrange,),
                Spacer(),
              ],
            ),
            Row(
